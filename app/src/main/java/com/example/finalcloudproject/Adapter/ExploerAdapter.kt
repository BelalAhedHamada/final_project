...
import com.example.finalcloudproject.databinding.ItemExploerBinding
import com.example.finalcloudproject.databinding.ItemTopicBinding
import java.util.Random

class ExploerAdapter : RecyclerView.Adapter<ExploerAdapter.ViewHolder>() {
    inner class ViewHolder(binding: ItemExploerBinding) : RecyclerView.ViewHolder(binding.root) {
        var name = binding.nameExp
        var image = binding.imageViewEx
        var card = binding.itemCardEx
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemExploerBinding.inflate(LayoutInflater.from(parent.context), parent, false)
